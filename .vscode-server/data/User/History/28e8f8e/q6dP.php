...
<body class="bg-pink-50"> <!-- 浅粉色背景 -->
    ...
    <div class="container mx-auto p-8">
        ...
        <div class="text-center mb-12">
            ...
            <!-- 检查用户是否存在 -->
            @if($user)
                <p class="text-xl text-gray-700 mt-2">Hi, {{ $user->name }}! Explore our flowers and manage your profile.</p>
            @else
                <p class="text-xl text-gray-700 mt-2">Please log in to see your profile.</p>
            @endif
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg mb-8">
            ...
            <div class="mt-4">
                @if($user)
                    <p class="text-lg text-gray-800">Name: {{ $user->name }}</p>
                    <p class="text-lg text-gray-800">Email: {{ $user->email }}</p>
                @else
                    <p class="text-lg text-gray-800">No user information available. Please log in.</p>
                @endif
            </div>
        </div>
