    ...
    <div class="container">
        ...
        <div class="flex justify-between items-center dashboard-header">
            ...
            <div class="header-right">
                <p class="text-white">You are log in!</p>
                    ...
                    <div class="p-8 text-gray-900 space-y-8">
                        ...
                        <div class="flower-management">
                            ...
                            <div class="flower-list mt-8 space-y-6">
                                <!-- Removed the if condition and loop, we will just show the form for flower creation -->
                                <p class="text-gray-600">To add a new flower, click the "Create New Flower" button above.</p>
                            </div>
                        </div>
