            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-6 text-gray-900 space-y-6">
                        ...
                        <!-- 图片展示 -->
                        <div class="image-placeholder bg-gray-200 p-4 rounded-lg mt-8">
                            <!-- 图片的尺寸稍微调整，减少占用的空间 -->
                            <img src="{{ asset('images/Dashboard%20flower.jpg') }}" alt="Dashboard Flower" class="w-64 h-auto mx-auto rounded-lg">
                        </div>
