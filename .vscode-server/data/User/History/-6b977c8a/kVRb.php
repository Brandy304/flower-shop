...
// 默认仪表盘页面（没有角色的用户），可以移除此路由，因为在 DashboardController 已经处理
 Route::middleware('auth')->get('/default-dashboard', [DefaultDashboardController::class, 'index'])->name('default-dashboard');
