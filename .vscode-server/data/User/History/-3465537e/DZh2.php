...
<body>
    <div class="container mx-auto p-6" style="background-color: #ffe4e1;"> <!-- 设置背景颜色为浅粉色 -->
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg mb-8">
            <h3 class="text-xl font-semibold text-pink-600">Admin Users</h3>
        ...
        <!-- Florist 用户列表 -->
        <div class="bg-white p-6 rounded-lg shadow-lg mb-8">
            <h3 class="text-xl font-semibold text-pink-600">Florist Users</h3>
            <div class="overflow-x-auto mt-4">
                <table class="min-w-full table-auto">
                    <thead class="bg-pink-100">
                        <tr>
        ...
        <!-- 其他用户列表 -->
        <div class="bg-white p-6 rounded-lg shadow-lg mb-8">
            <h3 class="text-xl font-semibold text-pink-600">Other Users</h3>
            <div class="overflow-x-auto mt-4">
                <table class="min-w-full table-auto">
                    <thead class="bg-pink-100">
                        <tr>
                    ...
                    <tbody>
                        @foreach($otherUsers as $user)
                            <tr class="border-b hover:bg-pink-50">
                                <td class="px-4 py-2 text-gray-800">{{ $user->name }}</td>
                                <td class="px-4 py-2 text-gray-800">{{ $user->email }}</td>
                                <td class="px-4 py-2 text-gray-800">No Role</td>
                                <td class="px-4 py-2 text-center">
                                    <a href="#" class="bg-blue-500 text-white py-1 px-4 rounded-lg hover:bg-blue-600 transition duration-300">Edit</a>
                                    <form action="#" method="POST" class="inline-block">
                                        @csrf
