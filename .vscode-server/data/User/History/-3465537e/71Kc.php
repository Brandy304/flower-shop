                ...
                <table class="min-w-full table-auto">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-pink-50">
                            ...
                            <td class="px-4 py-2 text-gray-800">32340016332@qq.com</td>
                        ...
                        <!-- Florist 用户 -->
                        <tr class="border-b hover:bg-pink-50">
                            <td class="px-4 py-2 text-gray-800">Yuan Yin (Brandy)</td>
                            <td class="px-4 py-2 text-gray-800">3819533682@qq.com</td>
                            <td class="px-4 py-2 text-gray-800">
                        ...
                        <!-- 新用户 User -->
                        <tr class="border-b hover:bg-pink-50">
                            <td class="px-4 py-2 text-gray-800">User</td>
                            <td class="px-4 py-2 text-gray-800">user@qq.com</td>
                            <td class="px-4 py-2 text-gray-800">
                                <span class="bg-pink-200 text-pink-600 py-1 px-3 rounded-full text-xs">User</span>
                            </td>
                            <td class="px-4 py-2 text-center">
                                <a href="#" class="bg-blue-500 text-white py-1 px-4 rounded-lg hover:bg-blue-600 transition duration-300">Edit</a>
                                <form action="#" method="POST" class="inline-block">
                        ...
                        <!-- 如果没有用户的情况 -->
                        <tr>
                            <td colspan="4" class="px-4 py-2 text-center text-gray-800">No more users found. Add some users to manage.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
