...
<body>
    <div class="container mx-auto p-6" style="background-color: #ffe4e1;"> <!-- 设置背景颜色为浅粉色 -->
        ...
        <div class="text-center mb-12">
            <h1 class="text-3xl font-bold text-pink-600">Admin Dashboard</h1> <!-- 标题改为深粉色 -->
            <p class="text-lg text-gray-700">Welcome, Admin! Here you can manage users and their roles.</p>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg mb-8">
            <h3 class="text-xl font-semibold text-pink-600">Manage Users</h3> <!-- 标题改为深粉色 -->
